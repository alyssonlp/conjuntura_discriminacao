...
r_hab_all <- dt1 %>%
  ...
  geom_text(aes(label = round(renda_media_hab)), vjust = -0.5, position = position_dodge(width = 0.8), size = 5) +
...
massa_hab <- dt2 %>%
  ...
  geom_bar(stat = 'identity', position = position_dodge(width = 0.8), width = 0.7) +
  geom_text(aes(label = round(massa_hab)), vjust = -0.5, position = position_dodge(width = 0.8), size = 5) +
  scale_fill_manual(name = "",
                    values = c("Homem Branco" = "aquamarine4",
                               "Mulher Branca" = "darkorange1",
                               "Homem Negro" = "darkgoldenrod1",
...
gini_hab <- dt1 %>%
  ...
  geom_bar(stat = 'identity', position = position_dodge(width = 0.8), width = 0.7) +
  geom_text(aes(label = round(gini_hab,2)), vjust = -0.5, position = position_dodge(width = 0.8), size = 5) +
  scale_fill_manual(name = "",
                    values = c("Homem Branco" = "aquamarine4",
                               "Mulher Branca" = "darkorange1",
                               "Homem Negro" = "darkgoldenrod1",
