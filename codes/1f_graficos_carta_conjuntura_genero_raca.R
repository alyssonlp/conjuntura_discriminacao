...
# gph unemp
pdf(file.path(figures_output, "unemp_gen_raca.pdf"),  width = 12, height = 8.5)
unemp_gen_raca <- gen_raca %>% 
...
print(unemp_gen_raca)
dev.off()

# gph PEA
pdf(file.path(figures_output, "pea_gen_raca.pdf"),  width = 12, height = 8.5)
pea_gen_raca <- gen_raca %>% 
